...
export default function Aksiya() {
    return (
        <div className='max-w-7xl mx-auto mt-[56px]'>
            <div className=''>
                <Title text={"Aksiyadagi mahsulotlar"} />
            </div>
            <div className='grid grid-cols-5 gap-8'>
                <div className='w-[224px] h-[387px] bg-white rounded-[12px] mt-8 '>
                    <div className='pt-[24px] pb-12px  flex flex-col items-center relative '>
                        ...
                        <div className=' absolute mt-[4px]  ml-[4px] top-0 left-0 w-[57px] h-[24px] bg-[#F63D68] font-normal    text-[13px] text-[#FFFFFF] rounded-[8px]'>
                            <h1 className='py-[4px] px-2'>Aksiya</h1>
                        </div>
                    </div>
                ...
                <div className='w-[224px] h-[387px] bg-white rounded-[12px] mt-8 '>
                 ...
                 <div className="w-[400px] h-[55px] bg-[#FFFFFF]  text-[#4D5761] flex items-center justify-center mb-[72px] rounded-[12px] border border-[#E5E7EB] ml-[426.5px]">
                    <button className=' '>Ko’proq ko’rsatish</button>
                </div>
